        ...
        // Wait to set the image src until the user stops typing
            ...
            // workflow. So in this case e = forcedTarget = null.
                   ...
                   if (!this.froalaEditors[thisTarget.id]) {
                       ...
                       $('#' + thisTarget.id).on('froalaEditor.initialized', function (e, editor) {
                           editor.events.bindClick($('body'), 'a#init-course-overview', function() {
                             var template = '\
<section class="about">\n\
  <h2>강좌 소개</h2>\n\
  <p>강좌 소개에 대한 설명을 입력합니다.</p>\n\
</section>\n\
\n\
<section class="content_list">\n\
  ...
  <table style="width:100%;">\n\
    <thead>\n\
      <tr>\n\
        <th colspan="2" style="width:50%; text-align:center;">주차</th>\n\
        <th style="width:50%; text-align:center;">주차</th>\n\
      </tr>\n\
    </thead>\n\
    <tbody>\n\
      <tr>\n\
        <td rowspan="3" style="width:10%; text-align:center; vertical-align:top;">1</td>\n\
        <td rowspan="3" style="width:40%; text-align:left; vertical-align:top;">주차 제목</td>\n\
        <td style="width:50%; text-align:left;">소주제</td>\n\
      </tr>\n\
      <tr>\n\
        <td colspan="3" style="width:50%; text-align:left; vertical-align:top;">소주제</td>\n\
      </tr>\n\
      <tr>\n\
        <td colspan="3" style="width:50%; text-align:left; vertical-align:top;">소주제</td>\n\
      </tr>\n\
      <tr>\n\
        <td rowspan="3" style="width:10%; text-align:center; vertical-align:top;">2</td>\n\
        <td rowspan="3" style="width:40%; text-align:left; vertical-align:top;">주차 제목</td>\n\
        <td style="width:50%; text-align:left;">소주제</td>\n\
      </tr>\n\
      <tr>\n\
...
<section class="course-staff">\n\
  ...
  <article class="teacher">\n\
    <div class="teacher-image">\n\
      <img src="" alt="" class="fr-fic fr-dii">\n\
    </div>\n\
    <div class="biography">\n\
      <h3>이름</h3>\n\
      <p>연혁1</p>\n\
