...
def _section_data_download(course, access):
    ...
    section_data = {
        ...
        'export_matchup_csv_url': reverse('export_matchup_csv', kwargs={'course_id': unicode(course_key)}),
        'export_certificate_csv_url': reverse('export_certificate_csv', kwargs={'course_id': unicode(course_key)}),
